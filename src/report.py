...
def build_pdf_report(data: dict[str, Any]) -> bytes:
    ...
    story += [score_table, Paragraph("AI scores are guidance, not academic grades. Screenplay formatting is assessed separately and does not affect this score.", small)]
